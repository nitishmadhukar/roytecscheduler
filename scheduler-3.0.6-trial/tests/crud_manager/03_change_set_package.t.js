StartTest(function(t) {
    ...
    Ext.define('TestModel', {
        ...
        fields  : ['id', 'f1', 'f2', 'f3', { name : 'f4', critical : true }],
    ...
    t.it('Supports setting of a record back to its original values', function (t) {
        ...
        var r1      = resourceStore.getById('r1'),
            oldName = r1.getName();

        r1.setName('Some Name');
    ...
    t.it('Change set package for modified data', function (t) {
        ...
        t.isDeeply(pack.something.added, [{ f1 : '55', f2 : '555', f4 : undefined, '$PhantomId' : newRec[0].getId(),
        ...
        t.isDeeply(pack.something.updated, [{ id : 1, f1 : '-11', f4 : 'foo' }, { id : 2, f2 : '-222', f4 : undefined }], 'Correct list of updated records');
