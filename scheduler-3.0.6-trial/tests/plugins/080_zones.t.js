StartTest(function (t) {
    var innerTest = function (t, isTree, orientation) {
        ...
        t.chain(
            { waitForSelector : ['.myZoneStyle', scheduler.el], desc : 'Zone rendered ok, setting custom zone style works' },
            ...
            { waitForSelector : ['.otherZoneStyle', scheduler.el], desc : 'Adding new zone dynamically works' },
