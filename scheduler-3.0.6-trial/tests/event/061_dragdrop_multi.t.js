StartTest(function(t) {
    ...
    function getContext(t, config) {
        ...
        var scheduler = t.getScheduler(Ext.apply({
            ...
            eventStore : t.getEventStore({
                data: [
                    ...
                    { Id: 'e11', ResourceId: 'r2', Name: 'Assignment 2', StartDate: "2011-01-05", EndDate: "2011-01-08" }
                ]
            })
        }, config));
        ...
        var testSteps = [
            ...
            // Drag back again
            { drag : '.sch-event', by : function() { return scheduler.orientation === 'horizontal' ? [-100, -30] : [-100, -50]; } },
