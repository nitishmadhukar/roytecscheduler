StartTest(function(t) {
    ...
    // refresh is postponed only if stores are loading while view is instantiating
    // test doesn't make sense anymore
    // for more info check ticket #1873
    t.xit('Panel prevents own refresh while event store is not loaded', function (t) {
    ...
    // test doesn't make sense anymore
    // for more info check ticket #1873
    t.xit('Panel prevents own refresh while event store is not loaded (when event store gets loaded before resource store)', function (t) {
    ...
    // ticket #1873 describe exact situation, we find desirable here, as undesirable 
    t.xit('Panel gets start end dates from new events', function (t) {
        ...
        t.waitFor(100, function () {
            ...
            // ticket related - 1814
            t.snooze('2015-03-05', function (todo) {
                todo.willFireNTimes(view, 'refresh', 1, 'refresh event will be fired 1 times');
            });
