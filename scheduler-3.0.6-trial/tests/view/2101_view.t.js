    ...
    t.it('Basic API tests', function (t) {
        ...
        t.chain(
            ...
            function (next) {
                ...
                t.is(view.resolveResource(sched.getEl().down('.sch-timetd', true)), sched.resourceStore.first(), 'resolveResource horizontal')
            ...
            function (next) {
                ...
                t.is(view.resolveResource(sched.getEl().down('.sch-timetd', true)), sched.resourceStore.first(), 'resolveResource vertical')
                Ext.destroy(sched);
            }
        )
    })
