StartTest(function (t) {
    ...
    t.it('Drag create should work correctly', function (t) {
        ...
        t.chain(
            ...
            function (next) {
                t.isApprox(scheduler.el.down('.sch-dragcreator-proxy').getWidth(), 100, 2, 'Proxy width is correct');
                next();
            },
            { action : 'mouseUp' },
            function (next) {
...
//            { waitForCSSTransition : [scheduler.el, 100] },
    ...
    t.it('Setting new timeSpan should update view', function (t) {
        ...
        t.chain(
            ...
            function (next) {
                t.is(view.el.down('.sch-timetd').getWidth(), 75, 'Column width is correct');
            }
        );
    });
});