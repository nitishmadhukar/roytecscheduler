...
Ext.define("EventLogPanel", {
    ...
    constructor : function(config) {
        ...
        Ext.mixin.Observable.capture(scheduler.resourceStore, this.doLog, this.resourceStoreEvents);
        Ext.mixin.Observable.capture(scheduler.eventStore, this.doLog, this.eventStoreEvents);
