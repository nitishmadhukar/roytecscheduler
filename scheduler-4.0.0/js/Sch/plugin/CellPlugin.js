...
Ext.define('Sch.plugin.CellPlugin', {
    ...
    renderElement       : function () {
        ...
        me.containerEl = Ext.get(Ext.DomHelper.append(me.view.getSecondaryCanvasEl(), el));
    ...
    stopEditing     : function () {
        ...
        var node = me.lockedView.getRow(me.resource);
    ...
    onAfterSelect   : function (e) {
        ...
        Ext.fly(me.lockedView.getRow(me.resource)).down(me.lockedView.getCellSelector()).focus();
