...
if (isSmokeTest || isRelease) {
    // Only run smoke/release tests against the latest extjs version
...
//                'buffered_rendering/100_buffered_tree.t.js'
        ...
        },
        {
            ...
            items : [
                ...
                {
                    hostPageUrl : '../examples/print/print.html',
                ...
                isRelease ? [] : [
                        ...
                        },
                        {
                            ...
                            items : [
                                ...
                                {
                                    hostPageUrl : '../examples/weekview/weekview.html',
                                ...
                                {
                                    hostPageUrl : '../examples/externaldragdrop/externaldragdrop.html',
