    ...
    t.it('Simple use case', function(t) {
        ...
        t.chain(
            ...
            function (next) {
                ...
                view.scrollEventIntoView(event, false, false, function () {
    ...
    t.it('Vertical orientation', function(t) {
        ...
        t.chain(
            ...
            function (next) {
                ...
                view.scrollEventIntoView(scheduler.eventStore.first(), false, false, next);
            },
            function (next) {
                var eventEl = t.getFirstEventEl(scheduler);
                t.ok(eventEl, 'Should find event el in the DOM');
