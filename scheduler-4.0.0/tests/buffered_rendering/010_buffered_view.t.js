StartTest(function(t) {
    ...
    t.it('Should synchronize rows after buffered view scrolling', function(t) {
        ...
        t.chain(
            ...
            function (next) {
                ...
                // https://www.assembla.com/spaces/bryntum/tickets/1841
                // for some reason, real scrollTop value after scroll is 14 less than passed value
                // so to scroll to 0 we actually have to do this: t.scrollVerticallyTo(el, 14, 0, next)
                if (Ext.isIE9) {
            ...
            function (next) {
                ...
                // ticket https://www.assembla.com/spaces/bryntum/tickets/1841
                // t.is(normalView.getScroll().top, 0, "Top scroll should be 0");
                // t.is(lockedView.el.getScroll().top, 0, "Top scroll should be 0");
                next();
            }
            // https://www.sencha.com/forum/showthread.php?302499-Ext5.1.1-Buffered-scroll-and-normalview-refresh-results-in-blank-table
            //, function (next) {
            //    //Ticket https://www.assembla.com/spaces/bryntum/tickets/2108?comment=764544433#comment:764544433
            //    t.scrollVerticallyTo(el, el.dom.scrollHeight, 300, function () {
            //        eventStore.load({
            //            callback : function () {
            //                eventStore.load({callback : next})
            //            }
            //        })
            //    });
            //},
    ...
    t.it('Should keep event selection as you scroll rows in and out of view', function(t) {
        ...
        t.chain(
            ...
            function() {
                t.selectorExists('.selection .x-grid-item:nth-child(1) .sch-event-selected');
            }
        )
    })
})    
