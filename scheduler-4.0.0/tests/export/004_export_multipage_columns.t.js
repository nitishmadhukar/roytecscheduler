StartTest(function(t) {
    ...
    var scheduler   = t.getScheduler({
        ...
        columns     : [
            ...
            { header : 'Name1', dataIndex : 'Name', width : 100 },
            { header : 'Name2', dataIndex : 'Name', width : 100 },
            { header : 'Name3', dataIndex : 'Name', width : 100, hidden : true },
    ...
    var checkPanelColumns   = function (t) {
        ...
        t.ok(columns[1].isVisible(), 'Hidden column #1 is hidden');
    ...
    t.waitForRowsVisible(scheduler, function () {
        ...
        var columns = [],
            lc = scheduler.lockedGrid.columns;

        columns = [lc[0], lc[2], lc[4], lc[5], lc[6], lc[7]];
