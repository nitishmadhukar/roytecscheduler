StartTest(function (t) {
    t.it('Should support ceilDate', function (t) {
        ...
        t.it('Takes time into account', function (t) {
            t.is(ta.ceilDate(new Date(2013, 0, 1, 1), false, Sch.util.Date.YEAR), new Date(2014, 0, 1), '+1 year => ceil to next year');
            t.is(ta.ceilDate(new Date(2013, 0, 1, 1), false, Sch.util.Date.QUARTER), new Date(2013, 3, 1), '+1 quarter => ceil to next quarter');
        });
