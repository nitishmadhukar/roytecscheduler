    ...
    t.it("Should trigger scroll when creating event close to timeaxis edges", function (t) {
        ...
        t.chain(
            ...
            function(next) {
                ...
                t.isGreater(viewEl.down('.sch-dragcreator-proxy').getWidth(), viewEl.getWidth() - 10 + viewEl.getScroll().left, 'Proxy el should gain width after scrolling, at least one increment');
