    ...
    initComponent : function () {
        ...
        Ext.define('Meeting', {
            ...
            fields : [
                ...
                {name : 'StartDate', mapping : 'time', type : 'date', dateFormat : 'D M d H:i:s T Y'},
                {name : 'EndDate', mapping : 'time', type : 'date', dateFormat : 'D M d H:i:s T Y'},
                {name : 'name'},
                {name : 'description'},
                {name : 'status'},
                {name : 'time'},
