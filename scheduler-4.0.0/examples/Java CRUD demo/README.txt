...
After the command completion there will be created a new "target" folder where you can find "scheduler-crud.war" file.
...
There you have to pick built "scheduler-crud.war" file using "Select WAR file to upload" input box and then click "Deploy" button.
After this Tomcat will deploy the application to the following URL:

tomcat_host:tomcat_port/scheduler-crud/
